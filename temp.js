(function(d, a, c) {
  var f = d.requestAnimationFrame || d.webkitRequestAnimationFrame || d.mozRequestAnimationFrame || d.oRequestAnimationFrame || d.msRequestAnimationFrame ||
  function(g) {
  ...
  e.prototype = {
    ...
    _end: function(l) {
      ...
      var n = l.changedTouches ? l.changedTouches[0] : l,
      i,
      h,
      k = b.getTime() - this.startTime,
      g = c.round(this.x),
      q = c.round(this.y),
      p = c.abs(g - this.startX),
      o = c.abs(q - this.startY),
      j = 0,
      m = "";
    ...
    _initEvents: function(g) {
      ...
      i = this.options.bindToWrapper ? this.wrapper: d;
  ...
  c.prototype = {
    ...
    _scrollToNextEvent: function() {
      ...
      function(k) {
        ...
        var j = k.index > f,
        l = d.$items.eq(k.index)[j ? "next": "prev"](),
        m = l.offset() || d.$items.eq(k.index).offset(),
        i = $(d.el).offset(),
        h;
